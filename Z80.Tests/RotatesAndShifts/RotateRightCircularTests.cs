...
{
    public class RotateRightCircularTests : CpuRunTestBase 
    {
        [Test]
        public void RotateRegister() 
        {
            ...
            _cpu.C = 0b10011000;
            _cpu.Flags = Z80Flags.Zero_Z | Z80Flags.Sign_S | Z80Flags.ParityOverflow_PV | Z80Flags.HalfCarry_H | Z80Flags.AddSubtract_N | Z80Flags.Carry_C;

            // Act
            RunUntil(3);

            // Assert
            Assert.That(_cpu.C, Is.EqualTo(0b01001100));
        ...
        public void RotateHLPointedData() 
        {
            ...
            _cpu.Flags = Z80Flags.Zero_Z | Z80Flags.HalfCarry_H | Z80Flags.AddSubtract_N;

            // Act
            RunUntil(3);

            // Assert
            Assert.That(_ram[0x340a], Is.EqualTo(0b10101001));
        ...
        public void RotateIndexedPointedData() 
        {
            ...
            _cpu.Flags = Z80Flags.Zero_Z | Z80Flags.Sign_S | Z80Flags.HalfCarry_H | Z80Flags.AddSubtract_N | Z80Flags.Carry_C;
