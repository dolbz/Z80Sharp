...
{
    public class RotateRightTests : CpuRunTestBase 
    {
        [Test]
        public void RotateRegister() 
        {
            ...
            _cpu.D = 0b10011000;
            _cpu.Flags = Z80Flags.Zero_Z | Z80Flags.HalfCarry_H | Z80Flags.AddSubtract_N | Z80Flags.Carry_C | Z80Flags.ParityOverflow_PV;

            // Act
            RunUntil(3);

            // Assert
            Assert.That(_cpu.D, Is.EqualTo(0b11001100));
